...
private:
    ...
    double account_bal;
    int security_code;
    static int object_count; // Static variable to keep track of number of objects
...
public:
    ...
    Account() {
        ...
        account_bal = 0.0;
        security_code = 0;
        object_count++; // Increment object count when a new object is created
    }
...
int Account::object_count = 0; // Initialize static member
